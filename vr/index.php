...
<head>
    ...
    <script type="text/javascript" src="js/aframe-master.min.js?v=1.5.0"></script>
...
<a-scene id="vt_scene" scenelistener light="defaultLightsEnabled: false" style="opacity: 0;pointer-events: none;">
    ...
    <a-entity rotation="0 <?php echo $cam_rotation_fix; ?> 0">
    ...
    <a-entity id=“cam_wrapper” rotation="0 <?php echo $cam_rotation_fix; ?> 0">
        <a-entity id="cam" position="0 1.6 0" camera="fov:90;" camera look-controls="touchEnabled: false"
