...
var interval_access_time_avg = null, access_time_avg = 0;
            ...
            switch(data.object) {
                case 'marker':
                    ...
                    setTimeout(function () {
                        ...
                        sky.setAttribute("data-id-room", data.linkto.replace('#r_',''));
                        set_room_statistics();
                        ...
                        var room_target_north = room_target.getAttribute('data-north');
                        var rotation = 0 + ' ' + (room_target_north) + ' ' + 0;
