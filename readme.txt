...
=====FAQ & SUPPORT=====
https://simplesupport.ticksy.com

=====TUTORIALS=====
https://simplevirtualtour.tawk.help
...
=====CHANGELOG=====
8.1
- added compatibility for the Google Street View plugin
- added the ability to start the tour in fullscreen
- added the ability to translate title and description of protection section inside publish
- added the ability to select image from gallery into video project's image slide
- added Hebrew language
- fixed export vr standalone tours
8.0.2
