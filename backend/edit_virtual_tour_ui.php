                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select <?php echo (!$plan_permissions['enable_multilanguage']) ? 'disabled' : '' ; ?> onchange="save_vt_ui(false,false,false);" style="height: 125px" multiple class="form-control selectpicker" id="languages_enabled" data-container="body" data-actions-box="true" data-selected-text-format="count > 3" data-count-selected-text="{0} <?php echo _("items selected"); ?>" data-deselect-all-text="<?php echo _("Deselect All"); ?>" data-select-all-text="<?php echo _("Select All"); ?>" data-none-selected-text="<?php echo _("Only default language"); ?>" data-none-results-text="<?php echo _("No results matched"); ?> {0}">
                                        ...
                                        <?php if (check_language_enabled_viewer('he_IL', $settings['languages_viewer_enabled'])) : ?><option <?php echo (check_language_enabled_vt('he_IL', $settings['languages_viewer_enabled'], $virtual_tour['languages_enabled'])) ? 'selected':''; ?> id="ls_he_IL">עִברִית (he_IL)</option><?php endif; ?>
