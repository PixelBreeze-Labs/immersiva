                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="language">
                                        ...
                                        <?php if (check_language_enabled('he_IL',$settings['languages_enabled'])) : ?><option <?php echo ($user_info_edit['language']=='he_IL') ? 'selected':''; ?> id="he_IL">עִברִית</option><?php endif; ?>
                                        ...
                                        <div class="card-body pb-0 pt-2">
                                            <div class="form-group">
                                                <?php if($plan['ai_generate_mode']=='credit') { ?>
                                                    <label class="text-primary"><b><?php echo $ai_generated; ?></b> <?php echo _("used in total"); ?></label>
                                                <?php } else { ?>
                                                    <label class="text-primary"><b><?php echo $ai_generated; ?></b> <?php echo _("used this month"); ?></label>
                                                <?php } ?>
                                        ...
                                        <div class="card-body pb-0 pt-2">
                                            <div class="form-group">
                                                <?php if($plan['autoenhance_generate_mode']=='credit') { ?>
                                                    <label class="text-primary"><b><?php echo $autoenhance_generated; ?></b> <?php echo _("used in total"); ?></label>
                                                <?php } else { ?>
                                                    <label class="text-primary"><b><?php echo $autoenhance_generated; ?></b> <?php echo _("used this month"); ?></label>
                                                <?php } ?>
                                        ...
                                        <div class="card-body pb-0 pt-2">
                                            <div class="form-group">
                                                <?php if($plan['gsv_publish_mode']=='credit') { ?>
                                                    <label class="text-primary"><b><?php echo $gsv_published; ?></b> <?php echo _("used in total"); ?></label>
                                                <?php } else { ?>
                                                    <label class="text-primary"><b><?php echo $gsv_published; ?></b> <?php echo _("used this month"); ?></label>
                                                <?php } ?>
