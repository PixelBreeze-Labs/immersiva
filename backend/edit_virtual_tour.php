                            ...
                            <div class="col-md-3 <?php echo ($virtual_tour['external']==0) ? 'd-none' : ''; ?>">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="language">
                                        ...
                                        <?php if (check_language_enabled('he_IL',$settings['languages_enabled'])) : ?><option <?php echo ($virtual_tour['language']=='he_IL') ? 'selected':''; ?> id="he_IL">עִברִית (he_IL)</option><?php endif; ?>
