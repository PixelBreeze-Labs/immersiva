    ...
    <ul class="navbar-nav ml-auto">
                        ...
                        <div style="pointer-events:none;" class="dropdown-item">
                            ...
                            <?php if($gsv_installed && $plan_info['enable_gsv_publish']) : ?>
                                <?php switch($plan_info['gsv_publish_mode']) {
                                    case 'month': ?>
                                        <div id="progress_plan_gsv_publish" class="progress mt-1 position-relative" style="background-color:#b0b0b0;line-height:16px;">
        ...
        <li class="nav-item dropdown no-arrow lang_switcher">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="langDropdown">
                ...
                <?php if(check_language_enabled('he_IL',$settings['languages_enabled'])) : ?> <span style="cursor: pointer;" onclick="switch_language('he_IL');" class="<?php echo ($lang=='he_IL') ? 'lang_active' : ''; ?> noselect dropdown-item align-middle"><img class="mb-1" src="img/flags_lang/he_IL.png?v=2" /> <span class="ml-2">עִברִית</span></span> <?php endif; ?>
